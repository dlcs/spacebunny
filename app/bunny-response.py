...
def process_message(message):
    ...
    dlcs_id = base64.b64decode(data['userMetadata']['dlcsId'].encode("utf-8")).decode("utf-8")
    ...
    outputs_string = base64.b64encode(json.dumps(result_outputs).encode("utf-8")).decode("utf-8")
